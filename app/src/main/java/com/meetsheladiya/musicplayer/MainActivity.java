package com.meetsheladiya.musicplayer;
...
import com.meetsheladiya.musicplayer.adapters.AlbumsAdapter;
import com.meetsheladiya.musicplayer.adapters.ArtistsAdapter;
import com.meetsheladiya.musicplayer.adapters.ColorsAdapter;
import com.meetsheladiya.musicplayer.adapters.SongsAdapter;
import com.meetsheladiya.musicplayer.loaders.ArtistProvider;
import com.meetsheladiya.musicplayer.models.Album;
import com.meetsheladiya.musicplayer.models.Artist;
import com.meetsheladiya.musicplayer.models.Song;
import com.meetsheladiya.musicplayer.playback.EqualizerUtils;
import com.meetsheladiya.musicplayer.playback.MusicNotificationManager;
import com.meetsheladiya.musicplayer.playback.MusicService;
import com.meetsheladiya.musicplayer.playback.PlaybackInfoListener;
import com.meetsheladiya.musicplayer.playback.PlayerAdapter;
import com.meetsheladiya.musicplayer.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/meetsheladiya/MusicPlayer")));
